...
// EmblaCarousel component (no fancy animation)
export const EmblaCarousel: React.FC<{
  ...
  showArrows = true,
  className = "",
  maxRotateX = 0, // eslint-disable-line @typescript-eslint/no-unused-vars
  maxRotateY = 0, // eslint-disable-line @typescript-eslint/no-unused-vars
  maxScale = 0, // eslint-disable-line @typescript-eslint/no-unused-vars
  tweenFactorBase = 0, // eslint-disable-line @typescript-eslint/no-unused-vars
}) => {
      ...
      <div className="overflow-visible py-10" ref={emblaRef}>
        <div className="embla__container flex gap-3">
          {slides.map((slide, index) => (
            <div
              className="embla__slide [flex:0_0_14rem] max-[350px]:[flex:0_0_12rem]"
              key={index}
            >
              <div className="embla__slide__content h-full min-h-[17.5rem] w-full">
                {slide}
              </div>
            </div>
          ))}
